...
router.post('/', async(req, res) => {
    ...
    try {
        ...
        const result = await db.query('SELECT * FROM users WHERE nickname = $1 AND id = $2 AND password = $3', [nickname, id, password]);
        ...
        // DB에 회원 정보 저장
        await db.query('INSERT INTO users (nickname, id, password) VALUES ($1, $2, $3)', [nickname, id, hashedPassword]);
